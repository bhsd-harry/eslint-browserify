...
ruleTester.run("keyword-spacing", rule, {
    valid: [
        ...
        { code: "@dec class Foo {}", languageOptions: { parser: require("../parser") } },

        // get, set, async methods don't error with decorator
        { code: "class Foo { @dec get bar() {} @dec set baz() {} @dec async baw() {} }", languageOptions: { parser: require("../parser") } },
        { code: "class Foo { @dec static qux() {} @dec static get bar() {} @dec static set baz() {} @dec static async baw() {} }", languageOptions: { parser: require("../parser") } },

        // type keywords can be used as parameters in arrow functions
        { code: "symbol => 4;", languageOptions: { parser: require("../parser") } }
    ],
