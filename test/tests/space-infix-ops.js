...
ruleTester.run("space-infix-ops", rule, {
    valid: [
        ...
        // Type Annotations
        { code: "function foo(a: number = 0) { }", languageOptions: { ecmaVersion: 6, parser: require("../parser") } },
        { code: "function foo(): Bar { }", languageOptions: { ecmaVersion: 6, parser: require("../parser") } },
        { code: "var foo: Bar = '';", languageOptions: { ecmaVersion: 6, parser: require("../parser") } },
        { code: "const foo = function(a: number = 0): Bar { };", languageOptions: { ecmaVersion: 6, parser: require("../parser") } },

        // TypeScript Type Aliases
        { code: "type Foo<T> = T;", languageOptions: { ecmaVersion: 6, parser: require("../parser") } },
